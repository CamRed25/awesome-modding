...
- [AMMO (Almost Manual Mod Manager)](https://github.com/cyberrumor/ammo) - Terminal based Linux mod manager for Bethesda games.
...
- [Limo](https://github.com/limo-app/limo) - General purpose mod manager primarily developed for Linux with support for the Nexus Mods API and LOOT.
...
- [Crash Log Tools](https://github.com/Exit-9B/ModOrganizer-CrashLogTools) - Plugin that provide extra functionality for the Skyrim crash logs generated by [Crash Logger](https://www.nexusmods.com/skyrimspecialedition/mods/59596).
...
- [Profile Assistant](https://github.com/MaskedRPGFan/Profile-Assistant) - Plugin that automatically selects a profile and enables/disables mods based on the user's VRAM, system language and screen aspect ratio.
...
- [MAD x VP6 x MPC x MPV x WMV Compiler](https://github.com/bluesky-dev12/MAD-x-VP6-x-MPC-x-MPV-x-WMV-Compiler) - Compilation of tools that let's you compile WMV, MAD, VP6, MPC and MPV for Black Box games.
...
- [Anno 1800 Mod Loader](https://github.com/xforce/anno1800-mod-loader) - Mod loader for Anno 1800 that sups loading of unpacked RDA files, XML auto merging and DLL based mods.
...
- [FerrumC](https://github.com/ferrumc-rs/ferrumc) - Multithreaded reimplementation of the Minecraft server in Rust.
...
- [repak](https://github.com/trumank/repak) - Rust library and CLI tool for working with Unreal Engine 4 PAK files.
